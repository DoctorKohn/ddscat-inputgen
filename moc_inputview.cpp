...
static const char qt_meta_stringdata_InputView[] = {
    "InputView\0\0angle\0xRotationChanged(int)\0"
...
const QMetaObject InputView::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_InputView,
      qt_meta_data_InputView, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &InputView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_InputView))
...
// SIGNAL 0
void InputView::xRotationChanged(int _t1)
{
...
// SIGNAL 1
void InputView::yRotationChanged(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void InputView::zRotationChanged(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
